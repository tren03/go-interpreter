...
// Helper functions to add the prefix func for a specific token
...
func (p *Parser) parseExpression(precedence int) ast.Expression {
	// returns the function asscociated with the prefix operators
	...
	// returns the function asscociated with the infix operators
